...
Rectangle {
    ...
    function toggleBoard(index) {
        const next = expandedBoards.slice()
    ...
    ColumnLayout {
        ...
        ListView {
            ...
            delegate: Item {
                ...
                Column {
                    id: channelRows
                    visible: boardSection.expanded
                    width: parent.width
                    y: boardHeader.height + 8
                    spacing: 6
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                FieldStyle {
                                    ...
                                    onEditingFinished: {
                                        if (text.trim().length)
                                            root.channelNameRequested(card.channelIndex, text)
                                    }
                                }
                                ...
                                ComboBox {
                                    ...
                                    onActivated: root.channelColorRequested(card.channelIndex, ["#39e6bb", "#f2d05c", "#72d18c", "#c58bea", "#f0a35e", "#63b3ed", "#ef7aa8", "#a6d96a"][currentIndex])
